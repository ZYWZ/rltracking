...
class RLTracker(nn.Module):
    def __init__(self, hidden_dim=256, nheads=8, num_encoder_layers=3,
        ...
        self.transformer = StableTransformerXL(d_input=hidden_dim, n_layers=2,
            n_heads=4, d_head_inner=32, d_ff_inner=64)
    ...
    def forward(self, obs):
        ...
        action = self.linear_action(trans_state).softmax(-1).permute(1, 0, 2)
        return action
